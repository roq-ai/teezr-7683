...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Deals', path: '/deals', entity: 'deal', service: AccessServiceEnum.PROJECT, icon: FiPercent },
    ...
    { name: 'Offers', path: '/offers', entity: 'offer', service: AccessServiceEnum.PROJECT, icon: FiGift },
