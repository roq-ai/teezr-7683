  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience Teezr, your tinder-style app presenting a world of offers and deals, tailored to your preferences. Swipe, match, and save on every deal!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1527264935190-1401c51b5bbc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvZmZlcnN8ZW58MHx8fHwxNzAwMDA0NDg4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@belart84?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Artem Beliaikin`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Teezr, your tinder-style app presenting a world of offers and deals, tailored to your preferences. Swipe, match, and save on every deal!`}
            </Text>
            <Box
