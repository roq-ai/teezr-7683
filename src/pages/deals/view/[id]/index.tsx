...
import { useDealFindFirst, useRoqClient } from 'lib/roq';
...
function DealViewPage() {
  ...
  const { data, error, isLoading } = useDealFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('deal', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/deals/edit/${id}`} passHref legacyBehavior>
                    <Button
