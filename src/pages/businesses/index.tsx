  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'deal.count', 'marketing_campaign.count', 'offer.count', 'user.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('deal', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Deal',
          accessorKey: 'deal',
          cell: ({ row: { original: record } }: any) => record?._count?.deal,
        }
      : null,
    hasAccess('marketing_campaign', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'marketing_campaign',
          header: 'Marketing Campaign',
          accessorKey: 'marketing_campaign',
          cell: ({ row: { original: record } }: any) => record?._count?.marketing_campaign,
        }
      : null,
